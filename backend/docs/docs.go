        ...
        "/devices/{id}": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "要更新的設備欄位",
                        "name": "device",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.PatchDeviceRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.CreateTelemetryRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/telemetries/{id}": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "要更新的遙測數據欄位",
                        "name": "telemetry",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.PatchTelemetryRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "api.DeviceResponse": {
            ...
            "properties": {
                ...
                "telemetries": {
                    "description": "這裡只放入 DTO 版本的 Telemetry",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api.TelemetryResponse"
                    }
